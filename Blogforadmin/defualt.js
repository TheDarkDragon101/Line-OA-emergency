    ...
    firebase.database().ref('blogs/').orderByChild('timestamp').once('value').then(function (snapshot) {
        ...
        if (data) {
            ...
            sortedDataArray.forEach(([key, value]) => {
                ...
                // Change to delete link to call delete_post function with post key
                let deleteLink = document.createElement('a');
                deleteLink.href = '#';
                deleteLink.classList.add('btn', 'btn-danger', 'mt-2');
                ...
                cardBody.appendChild(deleteLink); // Append delete link
